    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">MDM Report</div>
            </a>
            ...
            <li class="nav-item ">
                ...
                <div id="collapsePages1" class="collapse " aria-labelledby="headingPages1" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item " href="<?= base_url('/admin/aset/request'); ?>">Request</a>
                        <a class="collapse-item " href="<?= base_url('/admin/aset'); ?>">Daftar Aset</a>
            ...
            <li class="nav-item ">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url('/admin/aktivitas'); ?>">Aktivitas Karyawan</a>
                        <a class="collapse-item " href="<?= base_url('/admin/daftarpegawai'); ?>">Update</a>
                        <a class="collapse-item " href="Cuti.html">Pengajuan Cuti</a>
