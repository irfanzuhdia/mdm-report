            ...
            <div class="col-lg-7">
              <div class="p-5">
                <div class="text-center">
                  <h1 class="h4 text-gray-900 mb-4">Tambah Aset</h1>
                </div>
<?php if (!empty(session()->getFlashdata('error'))) : ?>
            ...
            <?php endif; ?>
            <form method="post" action="<?= base_url(); ?>/admin/tambahaset/process">
                <?= csrf_field(); ?>
                <div class="mb-3">
                    <label for="username" class="form-label">Nama Aset</label>
